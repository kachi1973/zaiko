            ...
            <div class="card-body">
                <form class="form-inline">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control" placeholder="品目コード" v-model.trim="search.id">
                    </div>
                    <div class="input-group input-group-sm">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control" placeholder="メーカ" v-model.trim="search.maker">
                    </div>
                    <div class="input-group input-group-sm">
                        <div class="input-group-prepend">
                        ...
                        <select v-model="search.sort" class="form-control">
                            <option value="0">品目コード 昇順</option>
                            <option value="1">品目コード 降順</option>
                            <option value="2">型式 昇順</option>
                            <option value="3">型式 降順</option>
                            <option value="4">名称 昇順</option>
                            <option value="5">名称 降順</option>
                            <option value="6">メーカ 昇順</option>
                            <option value="7">メーカ 降順</option>
                        </select>
                    </div>
...
export default {
	...
	mounted() {
        var t = this;
        try{
            var ret = JSON.parse(localStorage.getItem("szaiko_dlg.search"));
    ...
    methods: {
        ...
        search_func(pageNum){
            ...
            localStorage.setItem("szaiko_dlg.search", JSON.stringify(t.search));
			t.ing = true;
            $.ajax({
                type : "POST",
                url : root_path + "shukko/AjaxGetSZaikos",
                dataType : "json",
